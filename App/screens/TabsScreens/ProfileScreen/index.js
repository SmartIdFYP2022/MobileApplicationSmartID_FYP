            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.statsContainer}>
                    <View style={styles.statsBox}>
                        ...
                        <Text style={[styles.text, styles.subText]}>Semester</Text>
                    </View>
                    <View style={[styles.statsBox, { borderColor: "#DFD8C8", borderLeftWidth: 1, borderRightWidth: 1 }]}>
                        <Text style={[styles.text, { fontSize: 24 }]}>BCSM-F19-479</Text>
                        <Text style={[styles.text, styles.subText]}>RollNumber</Text>
                    </View>
                </View>
                ...
                >
                    <Text style={{ ...FONTS.med4, color: COLORS.white, textAlign: 'center' }}>{t('common:logout')}</Text>
                </LinearGradient>
            </TouchableOpacity>
            </ScrollView>
        </SafeAreaView>
