...
{
    public abstract class SmartPayWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static SmartPayWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(SmartPayWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<SmartPayDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<SmartPayDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<SmartPayDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<SmartPayDbContext, Task<T>> func)
        {
            T result;
