...
import DashBoardScreen from '../screens/TabsScreens/DashBoard';
// constants
  ...
  return (
        ...
        >
          ...
          <Tab.Screen
            ...
            options={{
              // @ts-ignore
              tabBarIcon: ({ ref }) => <Lottie ref={ref} loop={false} source={require('../assets/lottie-icons/home.icon.json')} style={styles.icon} />,
            }}
          ...
          <Tab.Screen
            ...
            options={{
              // @ts-ignore
              tabBarIcon: ({ ref }) => <Lottie ref={ref} loop={false} source={require('../assets/lottie-icons/upload.icon.json')} style={styles.icon} />,
            }}
          ...
          <Tab.Screen
            ...
            options={{
              // @ts-ignore
              tabBarIcon: ({ ref }) => <Lottie ref={ref} loop={false} source={require('../assets/lottie-icons/settings.icon.json')} style={styles.icon} />,
            }}
          ...
          <Tab.Screen
            ...
            options={{
              ...
              source={require('../assets/icons/account.png')} style={{width: 25, height: 25}} />,
            }}
